...
A person describes an activity, gets a suggested tCO₂e, funds a fiat balance, and retires credits against a Klima carbon class. They receive a public retirement certificate. The app never talks to Klima directly: the backend quotes, marks up, and retires so SaveMyPlanet can charge **10% over Klima’s cost**.
