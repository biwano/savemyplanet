...
import { retirementByIdRoutes } from './routes/retirements/id'
import { retirementsRoutes } from './routes/retirements/index'
...
export function createApp() {
  ...
  app.route('/retirements/:id', retirementByIdRoutes)
